# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="b244b-101">Выполнение завершенного проекта</span><span class="sxs-lookup"><span data-stu-id="b244b-101">How to run the completed project</span></span>
